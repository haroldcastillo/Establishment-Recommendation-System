    ...
    <div className='mt-[70px] mx-auto max-w-screen-lg px-4 pt-[70px] pb-4'>
      ...
      <div className='flex justify-between mb-4 items-center' >
        ...
        {isOwner?<>
          ...
          <PopperComponent>
            <Paper variant="elevation" elevation="3" className='p-4 w-[200px]'>
      ...
      <div className='flex flex-col md:flex-row mt-4 gap-4'>
        <div className=' grow'>
          ...
          <p className='text-[14px] text-justify'>{view.data.description}</p>
        </div>
        <Paper variant="elevation" elevation="3" className='p-4 w-[100%] md:max-w-[300px]'>
          <p className='font-semibold'>More Information</p>
          <hr className='my-2'/>
          <div className='flex flex-col gap-2'>
            <div className=''>
              <p className='font-bold opacity-70 text-[12px]'>Operation Hours</p>
              <p className='first-letter:uppercase'>{convertTo12Hour(view.data?.open)} to {convertTo12Hour(view.data?.close)}</p>
            </div>
            <div className=''>
              <p className='font-bold opacity-70 text-[12px]'>Location</p>
              <p className='first-letter:uppercase overflow-hidden'>{view.data.address}</p>
            </div>
            <div className=''>
              <p className='font-bold opacity-70 text-[12px]'>Contact Number</p>
              <p className='first-letter:uppercase'>{view.data.phone}</p>
            </div>
            <div className=''>
              <p className='font-bold opacity-70 text-[12px]'>Facebook</p>
              <IconButton aria-label="" onClick={()=>{router.push("/")}}>
