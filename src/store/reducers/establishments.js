import {
    ...
    VERIFY_ESTABLISHMENT_SUCCESS,
    VERIFY_ESTABLISHMENT_FAILURE,
...
export const establishmentReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case FETCH_ALL_ESTABLISHMENTS_SUCCESS:
            return {
                ...state,
                establishments: {
                    data: action.payload,
        ...
        case FETCH_ALL_ESTABLISHMENTS_FAILURE:
            alert("ERROR: " + "Something went wrong!");
            return {
                ...state,
                establishments: {
        ...
        case VERIFY_ESTABLISHMENT_SUCCESS:
            const updatedEstablishment = state.establishments.data.map(
                (establishment) =>
        ...
        case VERIFY_ESTABLISHMENT_FAILURE:
            alert("ERROR: " + "Something went wrong!");
            return {
                ...state,
                establishments: {
