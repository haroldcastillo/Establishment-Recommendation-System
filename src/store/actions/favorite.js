...
export const FETCH_FAVORITE_ESTABLISHMENTS_SUCCESS =
    "FETCH_FAVORITE_ESTABLISHMENTS_SUCCESS";
export const FETCH_FAVORITE_ESTABLISHMENTS_FAILURE =
    "FETCH_FAVORITE_ESTABLISHMENTS_FAILURE";
...
export function fetchFavoriteEstablishments({ establishmentId }) {
    return {
